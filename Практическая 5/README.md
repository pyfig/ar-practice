...
**Источник тест-кейсов:** локальный файл `data/testit_import_practice2_first_name_clean.xlsx`  
**Количество перенесенных тест-кейсов:** `11`  
**Раздел проекта для импорта:** `Практическая 2 - First Name`

![Импорт тест-кейсов в TestIT из XLSX](images/04-import-practice2-step7.png)
...
![Секция практической 2 после очистки импорта и добавления чек-листа](images/11-library-practice2-clean.png)
...
![Тест-кейсы по проверке поля First name в TestIT](images/06-practice2-imported.png)
...
![Тест-кейсы по баг-репортам в отдельной секции проекта](images/12-library-bug-cases.png)
...
**Локальная выгрузка для практической:** `data/google_sheets_bug_reports.csv`
...
![Google Sheets-таблица с баг-репортами](images/13-google-sheet.png)

![Ссылка типа Defect в карточке тест-кейса](images/14-defect-link.png)
...
![Категории ошибок в TestIT](images/10-defect-categories.png)
...
![Тест-план с результатами баг-ориентированных тестов](images/09-test-plan-bug-failures.png)
