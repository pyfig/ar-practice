...
Коллекция успешно импортирована и запущена в Postman. Одновременно зафиксированы реальные дефекты в готовых автотестах `ServerREST`, поэтому часть сценариев завершается падениями проверок, что отражено в итоговых результатах запуска.
